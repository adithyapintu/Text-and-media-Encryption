...
encryptionkey = pd.read_csv(r"C:\Users\Pintu\Downloads\mark 0.5\flask backend\decodekeynew.csv",sep=',', names=['Character', 'Byte'], header=None, skiprows=[0])
